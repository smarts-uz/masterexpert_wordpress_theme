...
<html <?php language_attributes(); ?> class=" js_active  vc_desktop  vc_transform  vc_transform ">
   ...
   <body class="stm_service-template-default single single-stm_service postid-571 theme-consulting woocommerce-js site_layout_miami header_style_2 eroom-enabled wpb-js-composer js-comp-ver-6.5.0 vc_responsive">
