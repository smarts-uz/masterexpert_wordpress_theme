                  ...
                  <div class="container">
                     <div class="breadcrumbs">
                        ...
                        <span property="itemListElement" typeof="ListItem">
                          <span property="name">Страница поиска</span>
                                 ...
                                 <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                      ...
                                      <!--  <div class="wpb_single_image wpb_content_element vc_align_left  vc_custom_1611997181345">
                                       ...
                                       <div class="vc_custom_heading text_align_left"><a href="<?php the_permalink() ?>">
                                          <h2 style="text-align: left" class="consulting-custom-title">
                                          	<?php the_title() ?>
                                          	</h2>
